...
public class KafkaProperties {
    ...
    public static class Producer {
         ...
         * <p>
         * Defaults to {@link EventProcessorMode#SUBSCRIBING}.
         */
    ...
    public static class Fetcher {
         ...
         * Defaults to {@code 10000} records.
         */
    ...
    public static class Consumer {
         ...
         * providing them to an Event Processor. Defaults to {@link EventProcessorMode#TRACKING}.
         */
    ...
    public enum EventProcessorMode {
        /**
         * For producing messages a subscribing event processor will be used. A subscribable message source will be
         * created for consuming messages.
         */
        SUBSCRIBING,
        /**
         * Use a tracking event processor to publish messages. A streamable message source will be created for
         * consuming messages.
         */
        TRACKING,
        /**
         * Use a pooled streaming event processor to publish messages. A streamable message source will be created
