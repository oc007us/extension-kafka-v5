...
/**
 * Interface to determine if an {@code EventMessage} should be published to Kafka, and if so to which topic.
 * If the result from the call is {@code Optional.empty()} it will not be published, else the result will be used
 * for the topic.
 *
 * @author Gerard Klijs
 * @since 4.6.0
