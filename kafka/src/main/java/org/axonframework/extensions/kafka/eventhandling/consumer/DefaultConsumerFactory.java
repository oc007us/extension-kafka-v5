 ...
 * {@link #createConsumer(String)} a new instance will be created based on the supplied {@code configuration}
 * properties.
 *
...
public class DefaultConsumerFactory<K, V> implements ConsumerFactory<K, V> {
    ...
    /**
     * Build a default {@link ConsumerFactory} which uses the provided {@code configuration} to build its
     * {@link Consumer}s.
     *
