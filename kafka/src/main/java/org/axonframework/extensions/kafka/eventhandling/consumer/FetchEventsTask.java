...
class FetchEventsTask<K, V, E> implements Runnable {
     ...
     * recordConverter} and consumed by the {@code eventConsumer}.
     *
     ...
     * @param offsetCommitType    the {@link OffsetCommitType} defining how offsets are committed
     */
    FetchEventsTask(Consumer<K, V> consumer,
        ...
        this.closeHandler = closeHandler != null ? closeHandler : task -> { /* no-op */ };
