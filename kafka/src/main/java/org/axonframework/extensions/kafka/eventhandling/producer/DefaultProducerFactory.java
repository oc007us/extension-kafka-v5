 ...
 * <p>
 * Setting {@link Builder#confirmationMode(ConfirmationMode)} to transactional produces a transactional producer;
 * in which case, a cache of producers is maintained; closing the producer returns it to the cache.
 *
 * @param <K> a generic type for the key of the {@link Producer} this factory will create
 * @param <V> a generic type for the value of the {@link Producer} this factory will create
 * @author Nakul Mishra
 * @since 4.0
 */
public class DefaultProducerFactory<K, V> implements ProducerFactory<K, V> {
     ...
     *
     * @param <K> a generic type for the key of the {@link Producer}
     * @param <V> a generic type for the value of the {@link Producer}
    ...
    /**
     * Abstract base class to apply the decorator pattern to a Kafka {@link Producer}.
     */
    ...
    /**
     * A decorator that returns itself to an instance pool when {@link #close()} is called.
     */
    ...
    /**
     * A decorator that ignores any calls to {@link #close()} so it can be reused.
     */
    ...
    public static final class Builder<K, V> {
         ...
         * @param temporalUnit a {@link TemporalUnit} determining how to interpret the timeout
         ...
         * Defaults to 30 seconds.
         *
         * @param closeTimeout the {@link Duration} to wait
         * @return the current Builder instance, for fluent interfacing
         */
        public Builder<K, V> closeTimeout(Duration closeTimeout) {
            assertThat(closeTimeout, d -> !d.isNegative(), "The closeTimeout should be a positive duration");
         ...
         *
         * @param configuration a {@link Map} of configuration properties
         * @return the current Builder instance, for fluent interfacing
         */
         ...
         *
         * @param confirmationMode the {@link ConfirmationMode}
         * @return the current Builder instance, for fluent interfacing
         */
         ...
         *
         * @param transactionIdPrefix a {@link String} specifying the prefix
         * @return the current Builder instance, for fluent interfacing
         */
