...
public interface Fetcher<K, V, E> {
    ...
    /**
     * Instruct this Fetcher to start polling messages through the provided {@link Consumer}. After retrieval, the
     * {@link org.apache.kafka.clients.consumer.ConsumerRecords} will be converted by the given {@code recordConverter}
     * and thereafter consumed by the given {@code eventConsumer}. A {@link Registration} will be returned to cancel
     * message consumption and conversion.
     *
     * @param consumer            the {@link Consumer} used to consume messages from a Kafka topic
     * @param recordConverter     a {@link RecordConverter} instance which will convert the "consumed"
     *                            {@link org.apache.kafka.clients.consumer.ConsumerRecords} into a List of {@code E}
     ...
     * @return a close handler of type {@link Registration} to stop the {@link Fetcher} operation
     */
