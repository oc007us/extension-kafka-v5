...
/**
 * A functional interface towards converting the {@link org.apache.kafka.clients.consumer.ConsumerRecord} instances
 * into a {@link List} of {@code E}.
 *
...
public interface RecordConverter<K, V, E> {
    ...
    /**
     * Convert the provided {@code records} into a {@link List} of elements of type {@code E}.
     *
     * @param records a {@link ConsumerRecords} instance to convert into a {@link List} of {@code E}
